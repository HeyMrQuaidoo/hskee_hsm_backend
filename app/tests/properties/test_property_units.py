...
class TestUnits:
    ...
    async def test_create_property(self, client: AsyncClient):
        ...
        TestUnits.default_units["utility"] = response_utility.json()["data"][0]  # Store utility data
        ...
        TestUnits.default_units["property_data"] = response.json()["data"]  # Store property data
    ...
    async def test_create_unit(self, client: AsyncClient):
        ...
        response = await client.post(
            "/unit/",
            json={
                "property_id":  TestUnits.default_units["property_data"].get("property_unit_assoc_id",""),
                ...
                "utilities": [
                    {
                        "billable_id":  TestUnits.default_units["utility"].get("utility_id",""),
                        "utility_id": TestUnits.default_units["utility"].get("utility_id",""),
        ...
        assert response.status_code == 201
        TestUnits.default_units["unit_data"] = response.json()["data"]  # Store unit data
