...
class Addresses(Base):
    ...
    rental_history: Mapped["PastRentalHistory"] = relationship(
        "PastRentalHistory",
        secondary="entity_address",
        primaryjoin="EntityAddress.address_id==Addresses.address_id",
        secondaryjoin="and_(EntityAddress.entity_id==PastRentalHistory.rental_history_id, EntityAddress.entity_type=='pastrentalhistory')",
        # overlaps="users",
        back_populates="address",
        lazy="selectin",
        viewonly=True,
    ...
    properties: Mapped["Property"] = relationship(
        "Property",
        secondary="entity_address",
        primaryjoin="EntityAddress.address_id==Addresses.address_id",
